...
@Data
@RequiredArgsConstructor // need to mark variables as required
public class FixedTransactionTemplate extends AbstractTransactionTemplate {
    private Date startDate;
    private Date endDate; // opt
    private Date nextTransactionDate; // opt
